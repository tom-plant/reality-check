...
def create_secondary_narrative(original_narrative_id, updated_fact_combination_id, narrative_text, counterstrat_id, user_id, news, outcome_text, _session=None):
    session = _session or db.session
