...
ENG = {
    "chatgpt_prompts": {
        "additional_narratives": {
            "generate_additional_narratives_system_content": 'Role: Political Commentator. Objective: Craft a narrative interpreting a recent security incident at a quantum computing facility. Use the following facts to construct a story that suggests deliberate actions by a specific party. Highlight potential motivations and implications. Aim for a narrative that firmly asserts one perspective, guiding the reader towards a clear understanding of the significance of the event. It should be straightforward, extremely readable, and compelling without using overly complex language or starting with a dependent clause. Present a declarative statement that reads smoothly. Assume the readers already know the context of the crisis so you do not need to repeat everything about the crisis if you do not want to. Focus solely on the conclusion without using terms like "narrative" or referencing the structure of the statement',
            "generate_additional_narratives_user_content": 'Construct a narrative in one single straightforward sentence using the provided facts. The narrative should assert a clear conclusion about who is responsible for the incident at the quantum computing facility and the subsequent disruptions, without suggesting the process of narrative creation. Focus on one potential actor or cause, avoiding ambiguity. Facts: “””{evidence}”””',
