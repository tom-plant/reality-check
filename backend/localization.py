...
ENG = {
   ...
   # Generative AI Prompts
    ...
    "generate_news_primary_system_content_story": "{headline} is the headline to your story. {selected_narrative} is the narrative you're pushing, and {selected_facts} are your main evidence, but make sure it weaves that information together in a story with a relevant news hook to set the scene. Keep it around 5-6 sentences.",
    ...
    # "generate_news_events_system_content_headline": 
    # "generate_news_events_user_content_headline": 
}
