...
const ExpoInbox = ({ setCurrentIntroView }) => {
  ...
  const initialEmails = [
    { id: 1, title: 'BBC Alerts', subject: 'Emergency Alert - Estonians Advised to Stay Home', description: 'Power substation attacks reported across major voting centers in Estonia... ', time: '9:04 AM' },
